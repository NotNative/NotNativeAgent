...
export function subagentConfig(config, type) {
  ...
  const rolePolicy = {
    ...
    tester: 'You are the test stage of a software delivery pipeline. Read the specification and implementation handoff, add focused tests, use project_verify for supported deterministic checks, and write the requested test artifact with its receipt.',
