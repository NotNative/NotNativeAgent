...
function enginePolicyMessage(config) {
  return {
    ...
    content: [
      ...
      'Use exact URLs supplied by the user, returned by web.search, or reached successfully through web.browse. Never invent, reconstruct, or edit a URL path from a title or remembered site structure. A model-proposed URL is unverified and may be attempted once; if it fails, do not retry that exact URL during the turn. Choose another exact discovered URL or navigate with web.browse.',
