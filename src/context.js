  ...
  return {
    ...
    content: [
      ...
      policySection('NNA self-knowledge', [
        ...
        'For a surprising or failed turn, use nna_diagnose_turn with selector list, latest, latest_failed, current, an exact session_id, or turn_offset 1 for the previous turn. Use nna_mcp_status or nna_mcp_test for private MCP configuration; do not search the project for private runtime settings.',
      ]),
