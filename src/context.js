  ...
  return {
    ...
    content: [
      ...
      config.executionManifest
        ...
        : 'In this root Console, process.run provides governed host process execution, including SSH and other remote-system commands; do not claim shell or SSH execution is unavailable while that tool is visible.',
