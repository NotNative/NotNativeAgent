...
export const EXTERNAL_BROWSER_GUIDANCE = 'Direct browser processes are not permitted through shell_run or process_run. Use web.fetch for bounded text retrieval, or web.browse for managed rendering, interaction, local-page serving, and screenshots.';
