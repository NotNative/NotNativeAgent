...
export function inlineInterpreterGuidance() {
  return 'Avoid embedding generated multi-statement programs in node -e, python -c, or similar argv: JSON, argv, and language escaping compound. Store the source with ref_store. Pass its draft identifier as stdin_ref to process_run. Use the interpreter stdin form: node with args ["-"] or python with args ["-"]. Keep inline evaluation for short, simple expressions.';
}
