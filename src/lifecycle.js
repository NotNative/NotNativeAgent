...
const TRANSITIONS = Object.freeze({
  ...
  recovering: ['invoking_model', 'compacting_context', 'preparing_continuation', 'awaiting_attention', 'finalizing_turn', 'cancelling'],
  awaiting_attention: ['preparing_continuation', 'finalizing_turn', 'cancelling'],
