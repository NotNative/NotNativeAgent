...
export const TUI_COMMANDS = Object.freeze([
  ...
  command('/websearch [status|configure URL|add NAME URL|test [ID]|promote ID|remove-profile ID|deploy|disable|remove]', 'Manage ordered SearXNG profiles', 'configuration'),
  ...
  command('/context level1 PERCENT', 'Set the receipt-compression threshold', 'configuration'),
  command('/context level2 PERCENT', 'Set the checkpoint-compression threshold', 'configuration'),
  command('/context level3 PERCENT', 'Set the aggressive-compression threshold', 'configuration'),
  command('/context compaction PERCENT', 'Set the full context-compaction threshold', 'configuration'),
  command('/plan [manage]', 'Open the durable conversation goal and task hub', 'workflows'),
  command('/tasks [manage]', 'Alias for /plan; inspect conversation work progress', 'workflows'),
  command('/goal [TEXT|complete EVIDENCE|reopen]', 'Create, update, complete, or reopen the conversation goal', 'workflows'),
  command('/task add TEXT', 'Add one ordered conversation task', 'workflows'),
  command('/task start|pending ID', 'Change the active state of a conversation task', 'workflows'),
  command('/task complete ID EVIDENCE', 'Complete a task with concrete evidence', 'workflows'),
  command('/task block ID REASON', 'Block a task with a specific reason', 'workflows'),
  ...
  command('/verify [focused|affected|full] [PATH ...]', 'Run governed project checks with durable evidence', 'workflows'),
  ...
  command('/devteam [REQUEST]', 'Bring a full team to plan, build, test, challenge, and verify a software change', 'workflows'),
  command('/research [QUESTION]', 'Run source-diverse, contradiction-tested deep research', 'workflows'),
