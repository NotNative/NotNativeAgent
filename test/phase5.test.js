...
import { EditorBuffer, TuiProjection } from '../src/experience/projection.js';
import { validateKeyBindings } from '../src/experience/key-bindings.js';
...
import { finalizeTui, handleActions, runTui, shouldExitOnCancel, submitEditor } from '../src/tui.js';
import { adaptiveRenderDelay, createRenderLoop } from '../src/tui/render-loop.js';
...
test('kernel context treats the workspace as context instead of an implicit task', () => {
  ...
  assert.match(policy, /session_search_history then session_read_history/u);
