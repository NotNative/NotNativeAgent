...
test('context compaction status is concise and visible', () => {
  ...
  assert.match(contextCompactionText({ status: 'completed', before_estimated_tokens: 220000, after_estimated_tokens: 48000, retained_records: 17 }), /Context compacted.*retained 17/u);
