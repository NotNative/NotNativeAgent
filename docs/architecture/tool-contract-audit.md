...
| NNA guidance/diagnostics | `nna_search_guidance`, `nna_read_guidance`, `nna_diagnose_turn`, `nna_list_sessions`, `nna_mcp_status`, `nna_mcp_test` | Pass. Selector conflicts and exact-id behavior are now visible through retained field descriptions. |
