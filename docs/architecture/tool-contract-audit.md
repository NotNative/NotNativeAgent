...
| NNA guidance/diagnostics | `nna.search_guidance`, `nna_read_guidance`, `nna_diagnose_turn`, `nna_list_sessions`, `nna.mcp_status`, `nna.mcp_test` | Pass. Selector conflicts and exact-id behavior are now visible through retained field descriptions. |
