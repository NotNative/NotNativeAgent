...
| Discovery and execution | `tool_search`, `process_run`, `shell_run`, `project.verify` | Pass. Interpreter, stdin-reference, accepted-exit-code, and verification-scope requirements are provider-visible. Native elevation launchers fail with guidance to ask the user to run the command independently. |
