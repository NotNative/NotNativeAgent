...
| Durable work | `work_plan`, `work_status`, `work_goal`, `work.task_add`, `work_task_update` | Pass with documented relational rules. Atomic plan replacement is intentionally retained; completion evidence and blocking detail requirements are visible. |
